...
t.SupercompleteProvider = class {
    ...
    maybeTriggerSupercomplete(editor, triggerCondition, supercompleteTriggerCondition, forceTrigger = false) {
        ...
        if (isSingleCursor && isSupercompleteEnabled && isImplicitTrajectoryEnabled && isConfigEnabled) {
            ...
            // 6. 创建命令请求
// supercompleteTriggerCondition: SupercompleteTriggerCondition.AUTOCOMPLETE_ACCEPT
            const commandRequest = new HandleStreamingCommandRequest({
                ...
                experimentConfig,
                requestSource: CommandRequestSource.SUPERCOMPLETE,
                diffType: DiffType.TMP_SUPERCOMPLETE,
                parentCompletionId: '',
                diagnostics: [],
